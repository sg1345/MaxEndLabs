...
namespace MaxEndLabs.Data.Repository.Contracts
{
	...
	{
		Task<IEnumerable<Order>> GetPageOrdersAsync(Guid userId, int skip, int take);
		...
		Task<Order?> GetOrderByIdAsync(Guid id, bool isFiltered, bool includeOrderItem, bool includeUser);
